 ...
 */
open class MyCanvasView(context: Context) : View(context) {
    private val TAG = MyCanvasView::class.java.simpleName
    ...
    override fun onSizeChanged(width: Int, height: Int, oldWidth: Int, oldHeight: Int) {
        ...
        letterPaint.textSize = 1000F
        letterPaint.color =
            ContextCompat.getColor(context, com.google.android.material.R.color.material_grey_100)

        // Draw a letter in the center of the canvas.
        val xPos = width / 2
        val yPos = (height / 2 - (letterPaint.descent() + letterPaint.ascent()) / 2).toInt()
        extraCanvas.drawText("A", xPos.toFloat(), yPos.toFloat(), letterPaint)
    }
